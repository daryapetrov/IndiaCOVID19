...
colnames(df_dates)[1] = "state" #rename column
...
df_codes=read.csv("../data/EconomicTracker/data/GeoIDs - State.csv", header = TRUE)
...
setwd("../data/covid_tracking/states_data/")
...
df_google = read.csv("../../EconomicTracker/data/Google Mobility - State - Daily.csv",header = TRUE)
...
save(covid_final,file="~/Desktop/covid_df.Rda")
